...
namespace OrgPalThreeDemo.Peripherals
{
    ...
    public static class LufftConnection
    {
        //Connection type
    ...
    public class LufftUmbProtocol
    {
        ...
        const byte DEFAULT_UMB_SINGLE_REQUEST_TYPE = 0x23; // Defined as: the command for the online data request
        //const byte DEFAULT_UMB_MULTI_REQUEST_TYPE = 0x2F; // Defined as: the command for the online data request

        public class UmbBinaryMessage
        {
            // Single Message Request structure (Ventus) ...
            ...
            public byte Command { get; set; } = DEFAULT_UMB_SINGLE_REQUEST_TYPE;
