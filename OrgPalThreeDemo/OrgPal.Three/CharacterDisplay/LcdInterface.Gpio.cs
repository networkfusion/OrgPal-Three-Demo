...
//                    Thread.Sleep(50); //DelayHelper.DelayMilliseconds(50, allowThreadYield: true);
//                    WriteBits(0b0011_0000, 8);
//                    Thread.Sleep(5); //DelayHelper.DelayMilliseconds(5, allowThreadYield: true);
//                    WriteBits(0b0011_0000, 8);
//                    Thread.Sleep(100); //DelayHelper.DelayMicroseconds(100, allowThreadYield: true);
//                    WriteBits(0b0011_0000, 8);
//                }
//                else
//                {
...
//                if (changedCount > 0)
//                {
//                    var pinValuePairs = new SpanPinValuePair(_pinBuffer, 0, changedCount);
//                    for (int i = 0; i < pinValuePairs.Length; i++)
//                    {
//                        _controller.Write(pinValuePairs[i].PinNumber, pinValuePairs[i].PinValue);
//                    }
//                }
...
//                Thread.Sleep(1); //DelayHelper.DelayMicroseconds(1, allowThreadYield: false);
