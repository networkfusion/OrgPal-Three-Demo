...
namespace PalThree
{
    ...
    public enum MCP342xPGA_Gain : byte
    {
        ...
        public MCP342x(int busId = PalThreePins.I2cBus.I2C2, ushort i2cAddress = 0x68)
        {
            address = i2cAddress;
            ...
            i2cBus = new I2cDevice(new I2cConnectionSettings(busId, address, I2cBusSpeed.StandardMode));
